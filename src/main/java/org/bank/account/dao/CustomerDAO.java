...
public class CustomerDAO {
    ...
    static final int INSERT_DATE_OF_BIRTH=3;
    static final int INSERT_GENDER=4;
    static final int INSERT_PHONE_NO=5;
    static final int INSERT_EMAIL=6;
    static final int INSERT_ADDRESS=7;
    static final int INSERT_AADHAR_NO=8;
    static final int INSERT_CUSTOMER_STATUS=9;
